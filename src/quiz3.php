...
/*$sql = 'SELECT image FROM questions';
          ...
          <ul class="p-quiz-box__answer__list">
            <?php foreach ($questions[$i]["choices"] as $choice) {?>
              <li class="p-quiz-box__answer__item">
                <button class="p-quiz-box__answer__button js-answer" data-answer="<?= $choice["id"] % 3?>" data-correct="<?= $choice["valid"]?>">
